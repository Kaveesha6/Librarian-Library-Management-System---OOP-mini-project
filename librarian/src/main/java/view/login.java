...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 400, 540, 260));
        ...
        jLabel6.setText("Librarian Library Management System");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 250, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\TiVA\\Documents\\mavenproject1\\librarian\\src\\main\\java\\images\\library_background.jpg")); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try {
            ...
            int result = userController.login(txtUsername.getText(), txtPassword.getText());
            if(result == 1){
                new librarian().setVisible(true);
                this.setVisible(false);
            }else{
                JOptionPane.showMessageDialog(null, "Wrong Username Aand Password", "Login Failed", JOptionPane.WARNING_MESSAGE);
            }
        } catch (Exception ex) {
